...
export const S = {
  ...
  appBg: { minHeight: "100vh", background: "#0f0f0f", fontFamily: "'DM Sans', sans-serif", color: "#fff", paddingBottom: 68 },
  ...
  reminderCard: { borderRadius: 14, padding: "14px 16px", marginBottom: 14, border: "1px solid #333" },
  reminderCardConfirmed: { background: "rgba(78,205,196,0.10)", borderColor: "rgba(78,205,196,0.35)" },
  reminderCardEmpty: { background: "#332a0f", borderColor: "#5a4a22" },
  reminderCardCancelled: { background: "#3a1f1c", borderColor: "#5c322c" },
  reminderStatusRow: { display: "flex", alignItems: "center", gap: 8, marginBottom: 2 },
  reminderIconOk: { width: 20, height: 20, borderRadius: "50%", background: "#4ECDC4", color: "#08130f", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, flexShrink: 0 },
  reminderIconWarn: { width: 20, height: 20, borderRadius: "50%", background: "#FFB347", color: "#2a2108", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, flexShrink: 0 },
  reminderIconDanger: { width: 20, height: 20, borderRadius: "50%", background: "#e2685a", color: "#280d08", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, flexShrink: 0 },
  reminderChipWrap: { display: "flex", flexWrap: "wrap", gap: 6, marginTop: 10, marginLeft: 28 },
  reminderChip: { fontSize: 11, fontWeight: 700, color: "#fff", background: "rgba(255,255,255,0.07)", border: "1px solid #333", padding: "3px 9px", borderRadius: 20 },
  // 快速Book表格（第0.2項）
  quickBookCard: { borderRadius: 14, padding: 14, marginBottom: 14, border: "1px solid #2c332f", background: "#171b19" },
  qbRow: { display: "flex", gap: 10, marginBottom: 10 },
  qbField: { flex: 1, minWidth: 0 },
  qbPreview: { background: "#1f1f1f", border: "1px solid #333", borderRadius: 10, padding: "8px 10px", margin: "10px 0" },
  qbPreviewRow: { display: "flex", justifyContent: "space-between", fontSize: 12, color: "#ccc", padding: "2px 0" },
  ...
  filmingTag: { fontSize: 10, color: "#fff", background: "#333", padding: "1px 6px", borderRadius: 6, marginLeft: 4 },
  ...
  moveBtn: { background: "#202020", border: "1px solid #333", color: "#aaa", fontSize: 10, padding: "2px 6px", borderRadius: 4, cursor: "pointer", lineHeight: 1 },
